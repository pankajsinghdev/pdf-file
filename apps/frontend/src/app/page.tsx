        ...
        <div className="relative isolate">
          ...
          >
            <div
              ...
              className="relative left-[calc(50%-11rem)] aspect-[1156/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-br from-[#ff80b5] to-[#9089fc] sm:left-[calc(50%-30rem)] sm:w-[72.1875rem] opacity-30"
            />
          </div>
          <div>
          ...
          >
            <div
              ...
              className="relative left-[calc(50%-13rem)] aspect-[1156/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-br from-[#ff80b5] to-[#9089fc] sm:left-[calc(50%-36rem)] sm:w-[72.1875rem] opacity-30"
            />
          </div>
        </div>
      </div>
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-z-12 md:space-y-0 gap-4">
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-1-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pl-0 md:pt-4">
              ...
              <span className="tmt-2 text-zinc-700">
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-1-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pl-0 md:pt-4">
              ...
              <span className="tmt-2 text-zinc-700">
                It&apos;s that simple, Try out PdfFile today.
              </span>
            </div>
          </li>
        </ol>
